  ...
  return (
    <div className="flex flex-col-reverse sm:flex-row items-center justify-center min-h-screen dark:bg-black bg-white">
      <div className="text-center sm:mr-4">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-2 text-black dark:text-white">
      ...
      <div className="mt-4 sm:mt-0">
        <div className="relative w-40 h-40 sm:w-52 sm:h-52 md:w-60 md:h-60">
          <div className="absolute inset-0 bg-gradient-to-tr dark:from-blue-500 dark:to-purple-500 from-blue-500 to-purple-500 opacity-75 rounded-full" />
          <Image
